...
<div class="container-fluid">
    ...
    <div class ="card-header-py-3">
        <h5 class ="m-0 font-weight-bold text-dark">Archive Documents</h5>
...
$query = "SELECT * FROM docu_try where status='archive'ORDER BY id DESC";
$query_run = mysqli_query($connection, $query);
  ...
  while ($row = mysqli_fetch_assoc($query_run))
   {
    ...
    <tr>
       ...
       <input type="hidden" name = "edit_id" value = "<?php echo $row['ID']; ?>">
        ...
        <button type ="submit" class = "btn btn-warning archive" name="submit" value="display">UnArchive</button>
