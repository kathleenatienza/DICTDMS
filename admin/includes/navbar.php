        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #002642">
            ...
            <a class="sidebar-brand my-5 d-flex align-items-center justify-content-center" href="index.php">
                ...
                <img src="img/logodict.png" width = "90" height = "90">
                </div>
                <div class="sidebar-brand-text">DICT Luzon Cluster 3<br>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="manage.php"><strong>Manage Documents</strong></a>
                        <a class="collapse-item" href="find.php"><strong>Find Documents</strong></a>
...
<div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <ul class="navbar-nav ml-auto">
           ...
           <small class =" text-dark mt-4 mx-2">Date/Time</small> <small class = " text-dark mt-4" id='ct7' ></small>
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                   ...
                   <P class = "my-2">USER PERSONAL NAME</p>
